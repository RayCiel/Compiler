...
public class MxParser extends Parser {
	...
	public static class AndandOperationContext extends ExpressionContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof MxVisitor ) return ((MxVisitor<? extends T>)visitor).visitAndandOperation(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class OrorOperationContext extends ExpressionContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof MxVisitor ) return ((MxVisitor<? extends T>)visitor).visitOrorOperation(this);
			else return visitor.visitChildren(this);
		}
	}
