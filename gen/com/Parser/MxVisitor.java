...
public interface MxVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by the {@code AndandOperation}
	 * labeled alternative in {@link MxParser#expression}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAndandOperation(MxParser.AndandOperationContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code OrorOperation}
	 * labeled alternative in {@link MxParser#expression}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitOrorOperation(MxParser.OrorOperationContext ctx);
	/**
