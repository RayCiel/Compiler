...
public interface MxVisitor<T> extends ParseTreeVisitor<T> {
	 ...
	 * @return the visitor result
	 */
	T visitPrefixOpration(MxParser.PrefixOprationContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitOrorOpration(MxParser.OrorOprationContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitAndandOpration(MxParser.AndandOprationContext ctx);
	/**
