...
public class Function {
    ...
    public Function(FuncType type) {
        this.retSize = type.getFuncEntity().getResult().getRegisterSize();
        this.name = type.getName();
        this.type = type;
        this.startBB = new BasicBlock(this, name + ".entry");
    }

    public Function(FuncEntity entity) {
        this.retSize = entity.getResult().getRegisterSize();
        this.name = entity.getType().getTypeName();
        this.type = (FuncType) entity.getType();
        this.startBB = new BasicBlock(this, name + ".entry");
    }
