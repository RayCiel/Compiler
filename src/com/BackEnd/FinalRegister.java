...
public class FinalRegister extends PhysicalRegister
{
        ...
        public FinalRegister(int id, String name, boolean isGeneral, boolean isCallerSave, boolean isCalleeSave) {
            this.id = id;
            this.name = name;
